(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/router'), require('rxjs/BehaviorSubject'), require('@angular/platform-browser'), require('rxjs/add/operator/distinctUntilChanged'), require('rxjs/add/operator/pluck'), require('@angular/forms')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/router', 'rxjs/BehaviorSubject', '@angular/platform-browser', 'rxjs/add/operator/distinctUntilChanged', 'rxjs/add/operator/pluck', '@angular/forms'], factory) :
	(factory((global['angular-admin-lte'] = {}),global.ng.core,global.ng.common,global.ng.router,global.Rx,global.ng.platformBrowser,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.ng.forms));
}(this, (function (exports,core,common,router,BehaviorSubject,platformBrowser,distinctUntilChanged,pluck,forms) { 'use strict';
...
var RoutingService = (function () {
    ...
    function RoutingService(router$$1) {
        ...
        this.onChange = new BehaviorSubject.BehaviorSubject(undefined);
        this.events = new BehaviorSubject.BehaviorSubject(undefined);
        this.init();
    }
    /**
     * [init description]
...
var LayoutStore = (function () {
    ...
    function LayoutStore(layoutConfig) {
        ...
        this._layoutState = new BehaviorSubject.BehaviorSubject(this.initialLayoutState);
...
var SidebarLeftComponent = (function () {
    ...
    SidebarLeftComponent.prototype.setMenuListeners = function (url) {
        if (url === '/') {
            ...
            var /** @type {?} */ primaryOutlet = this.router.parseUrl(url).root.children[router.PRIMARY_OUTLET];
            if (primaryOutlet) {
...
var LayoutService = (function () {
    ...
    function LayoutService(routingService) {
        this.routingService = routingService;
        this.isCustomLayout = new BehaviorSubject.BehaviorSubject(true);
        this.init();
    }
    /**
     * [init description]
...
InputTextComponent.propDecorators = {
    ...
    'inputTextLabelDirective': [{ type: core.ContentChild, args: [InputTextLabelDirective,] },],
    'inputTextAddonLeftDirective': [{ type: core.ContentChild, args: [InputTextAddonLeftDirective,] },],
    'inputTextAddonRightDirective': [{ type: core.ContentChild, args: [InputTextAddonRightDirective,] },],
};
...
exports.ɵbh = AccordionComponent;
exports.ɵbg = AccordionContentComponent;
exports.ɵbi = AccordionGroupComponent;
exports.ɵbf = AccordionHeaderComponent;
exports.ɵbj = AccordionToggleDirective;
exports.ɵbk = AlertComponent;
exports.ɵr = CollapseAnimationDirective;
exports.ɵq = AnimationsModule;
exports.ɵbq = BoxInfoComponent;
exports.ɵbr = BoxInfoContentDirective;
exports.ɵbs = BoxInfoFooterDirective;
exports.ɵbt = BoxInfoHeaderDirective;
exports.ɵbu = BoxSmallComponent;
exports.ɵbx = BoxSmallContentDirective;
exports.ɵbv = BoxSmallFooterDirective;
exports.ɵbw = BoxSmallHeaderDirective;
exports.ɵbl = BoxComponent;
exports.ɵbm = BoxContentDirective;
exports.ɵbn = BoxFooterDirective;
exports.ɵbp = BoxHeaderDirective;
exports.ɵbo = BoxToolsDirective;
exports.ɵb = BreadcrumbsComponent;
exports.ɵbd = BackgroundColorDirective;
exports.ɵbe = ColorDirective;
exports.ɵbc = ColorModule;
exports.ɵca = DropdownComponent;
exports.ɵbz = DropdownMenuComponent;
exports.ɵby = DropdownToggleComponent;
exports.ɵcb = InputTextComponent;
exports.ɵcd = InputTextAddonLeftDirective;
exports.ɵce = InputTextAddonRightDirective;
exports.ɵcc = InputTextLabelDirective;
...
exports.ɵch = TabComponent;
exports.ɵcg = TabContentComponent;
exports.ɵcf = TabHeaderComponent;
exports.ɵcj = TabsComponent;
exports.ɵci = TabsHeaderComponent;
exports.ɵck = TabToggleDirective;
