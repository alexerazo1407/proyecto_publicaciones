...
@Component({
  selector: 'app-articulos-regionales',
  templateUrl: './articulos-regionales.component.html',
  styleUrls: ['./articulos-regionales.component.css']
})
export class ArticulosRegionalesComponent implements OnInit {
  private mr: any;
