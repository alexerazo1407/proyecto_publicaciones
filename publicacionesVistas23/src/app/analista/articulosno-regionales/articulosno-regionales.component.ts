...
@Component({
  selector: 'app-articulosno-regionales',
  templateUrl: './articulosno-regionales.component.html',
  styleUrls: ['./articulosno-regionales.component.css']
})
export class ArticulosnoRegionalesComponent implements OnInit {
  private mr: any;
