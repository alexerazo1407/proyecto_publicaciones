...
@Component({
  selector: 'app-articulos-congreso',
  templateUrl: './articulos-congreso.component.html',
  styleUrls: ['./articulos-congreso.component.css']
})
export class ArticulosCongresoComponent implements OnInit {
  private mr: any;
